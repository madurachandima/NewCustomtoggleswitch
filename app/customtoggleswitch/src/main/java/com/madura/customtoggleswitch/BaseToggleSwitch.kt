...
abstract class BaseToggleSwitch : LinearLayout, CustomToggleSwitchButton.Listener {
    ...
    companion object Default {
        ...
        @JvmStatic private val EMPTY_TOGGLE_DECORATOR      = object:
            CustomToggleSwitchButton.ToggleSwitchButtonDecorator {
            override fun decorate(toggleSwitchButton: CustomToggleSwitchButton, view: View, position: Int) {}
        }

        @JvmStatic private val ENABLED                     = true

        @JvmStatic private val LAYOUT_ID                   = R.layout.custom_toggle_switch_button_view
    ...
    var prepareDecorator: CustomToggleSwitchButton.ToggleSwitchButtonDecorator = EMPTY_TOGGLE_DECORATOR
    var checkedDecorator:    CustomToggleSwitchButton.ViewDecorator?    = null
    var uncheckedDecorator:  CustomToggleSwitchButton.ViewDecorator?    = null

    var buttons = ArrayList<CustomToggleSwitchButton>()
    ...
    */
    ...
    fun setEntries(entries : List<String>) {
        ...
        val prepareDecorator = object: CustomToggleSwitchButton.ToggleSwitchButtonDecorator {
            override fun decorate(toggleSwitchButton: CustomToggleSwitchButton, view: View, position: Int) {
        ...
        val checkedDecorator = object: CustomToggleSwitchButton.ViewDecorator {
        ...
        val uncheckedDecorator = object: CustomToggleSwitchButton.ViewDecorator {
            override fun decorate(view: View, position: Int) {
                val textView = view.findViewById(R.id.text_view) as TextView
        ...
        setView(R.layout.custom_toggle_switch_button_view, entries.size,
                prepareDecorator, checkedDecorator, uncheckedDecorator)
    }

    fun setView(layoutId: Int, numEntries: Int,
                prepareDecorator: CustomToggleSwitchButton.ToggleSwitchButtonDecorator
    ) {
    ...
    fun setView(layoutId: Int, numEntries: Int,
                prepareDecorator: CustomToggleSwitchButton.ToggleSwitchButtonDecorator,
                checkedDecorator: CustomToggleSwitchButton.ViewDecorator?,
                uncheckedDecorator: CustomToggleSwitchButton.ViewDecorator?) {
        removeAllViews()
        buttons.clear()
        ...
        for (index in 0..numEntries - 1) {
            ...
            val button = CustomToggleSwitchButton(context, index, positionType, this,
    ...
    private fun getPosition(index : Int, size: Int) : CustomToggleSwitchButton.PositionType {
        if (index == 0) {
            return CustomToggleSwitchButton.PositionType.LEFT
        }
        else if (index == size - 1) {
            return CustomToggleSwitchButton.PositionType.RIGHT
        }
        else {
            return CustomToggleSwitchButton.PositionType.CENTER
        }
    }
