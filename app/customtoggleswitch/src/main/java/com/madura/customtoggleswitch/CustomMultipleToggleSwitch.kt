...
class CustomMultipleToggleSwitch(context: Context, attrs: AttributeSet?) : BaseToggleSwitch(context, attrs) {
    ...
    override fun onToggleSwitchClicked(button: CustomToggleSwitchButton) {
        if (isEnabled) {
